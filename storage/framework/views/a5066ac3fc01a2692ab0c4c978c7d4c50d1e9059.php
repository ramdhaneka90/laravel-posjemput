    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo e(Request::is('/') ? 'Customer' : 'Operator'); ?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
                <a href="<?php echo e(url('/order-history')); ?>">
                    <i class="fa fa-circle-o"></i>
                    History
                </a>
            </li>
...
<?php /**PATH /var/www/html/posjemputBaru/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>