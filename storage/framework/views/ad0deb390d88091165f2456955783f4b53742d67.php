 <header class="site-navbar py-4 js-sticky-header site-navbar-target coba" style="position:fixed; background: #ffffff; box-shadow: 0 5px 5px -5px rgba(0,0,0,.2);">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-10 d-none d-xl-block">
                       ...
                       onclick="event.preventDefault();
                                     document.getElementById('logout-form').submit();" class="nav-link child"><?php echo e(__('Logout')); ?></a></li>
        ...
        </header><?php /**PATH /var/www/html/posjemputBaru/resources/views/customer-views/header.blade.php ENDPATH**/ ?>